                ...
                >
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 relative z-10">
                            ...
                            {/* Left Side - Other Gateways (40%) */}
                            <div className="md:col-span-2 p-4 sm:p-6 lg:p-10 flex flex-col justify-center items-start text-left border-b md:border-b-0 md:border-r border-zinc-200 bg-zinc-50/30 min-w-0">
                            ...
                            <div className="md:col-span-3 p-4 sm:p-6 lg:p-8 xl:p-10 min-w-0">
                                ...
                                <div className="pt-4 sm:pt-6 border-t border-zinc-200">
                                    <div className="flex flex-wrap items-baseline gap-2 mb-4 sm:mb-6">
                                        <span className="text-lg sm:text-xl font-extrabold text-[#2ca3c9]">Custom</span>
                                        <span className="text-zinc-400 text-xs sm:text-sm">pricing / flexible duration</span>
                                    </div>
