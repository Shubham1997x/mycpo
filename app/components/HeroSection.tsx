  ...
  return (
    <section className="relative overflow-hidden pt-4">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 lg:pt-20 pb-12 sm:pb-16 lg:pb-24">
        ...
        >
          <div className="inline-flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-brand/10 text-brand text-[10px] sm:text-xs md:text-sm font-semibold mb-4 max-w-full mx-auto">
